 ...
 //<a href="https://www.flaticon.com/free-icons/return" title="return icons">Return icons created by Freepik - Flaticon</a>
  ...
  return (
    <div className="container">
      ...
      <div className="closebtn" onClick={() => setOverlayClass("overlayClosed") }>&times;</div>
      ...
      <div className="overlay-content">
            ...
            <SVGPause scale="25%" paused={isPaused} onChange={updatePauseStatus}/>
              <div className="text" id="pauseText">Pauses Game</div>
              <div className="text" id="resumeText">Resume with Arrow Buttons</div>
            <SVGReturnTop scale="25%"/>
              <div className="text" id="returnText">Exit to Main Screen</div>
        </div>
      ...
      <div className="spacing">
        <button className="unselectable" onClick={() => { triggerEvent('1'); setPausedState(false);}}>
          <SVGArrow direction="up" scale="90%" />
          Send Up
        </button>
      </div>
      ...
      <div className="spacing">
        <button className="unselectable" onClick={() => { triggerEvent('-1'); setPausedState(false);}}>
          <SVGArrow direction="down" scale="90%"/>
          Send Down
        </button>
      </div>
    </div>
      ...
      >
        <g transform="translate(-84.137 -120.7)">
          <path
            ...
            strokeWidth=".04827"
          />
          <g fill="#97b4d4" stroke="#fff" strokeWidth=".6">
...
function SVGPause(props) {
  if(props.paused == false && props.scale == "25%")
  {
    return (
      <svg
        className="pauseButtonInstructions"
        width="30%"
        height="45%"
        version="1.1"
        ...
        xmlns="http://www.w3.org/2000/svg">
          ...
          <path d="m24.07 82.585h21.943c2.2146 0 3.9974 1.7829 3.9974 3.9974v0.76546c0 2.2146-1.7828 3.9974-3.9974 3.9974h-21.943c-2.2146 0-3.9974-1.7829-3.9974-3.9974v-0.76546c0-2.2146 1.7829-3.9974 3.9974-3.9974z" fill="#00a0ff" fillRule="evenodd"/>
          <g aria-label="Play">
            <g strokeWidth=".070004" aria-label="Pause">
  ...
  else if(props.paused == true)
  {
    return (
      <svg
        ...
        xmlns="http://www.w3.org/2000/svg">
        <g transform="translate(-20.072 -82.585)" strokeWidth=".26458">
          <path d="m24.07 82.585h21.943c2.2146 0 3.9974 1.7829 3.9974 3.9974v0.76546c0 2.2146-1.7828 3.9974-3.9974 3.9974h-21.943c-2.2146 0-3.9974-1.7829-3.9974-3.9974v-0.76546c0-2.2146 1.7829-3.9974 3.9974-3.9974z" fill="#88a0c4" fillRule="evenodd"/>
          <g aria-label="Play">
          <g strokeWidth=".070004" aria-label="Pause">
            <path d="m29.919 85.95q0 0.61736-0.42168 0.94809-0.42168 0.32797-1.1879 0.32797h-0.46302v1.5682h-0.50712v-4.0294h1.0666q1.5131 0 1.5131 1.1851zm-2.0726 0.8406h0.40514q0.60082 0 0.87092-0.19293 0.2701-0.19568 0.2701-0.62563 0-0.38861-0.2508-0.58153t-0.78272-0.19292h-0.51263z"/>
...
function SVGReturnTop(props) {
  if(props.scale && props.scale)
  {
    return (
      //Return Button
      <svg 
      className="scaledReturn"
      width={props.scale}
      height={props.scale}
      version="1.1"
